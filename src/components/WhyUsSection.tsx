...
const features = [
  ...
  },
  {
    ...
    description: 'Premium education at prices that won\'t break the bank. Investment in your future, made accessible.',
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'No fluff, just actionable skills you can apply immediately in your career or business.',
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Join a thriving community of learners. Network, collaborate, and grow together.',
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: 'Cloud Access',
    description: 'Learn anytime, anywhere. Access your courses on any device with lifetime access.',
  },
  {
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export default function WhyUsSection() {
  return (
    <section id="why-us" className="relative py-20 md:py-32">
      {/* Background */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6">
            ...
            <span className="gradient-text">SkillsNova</span>
          </h2>
          <p className="text-lg text-gray-400 max-w-2xl mx-auto">
            We&apos;re not just another online course platform. We&apos;re your partner in career transformation.
          </p>
        </motion.div>
